...
public class Main {
    public static void main(String[] args) {
        ...
        var persons = new ArrayList<Person>(List.of(new Person(0, "46456456", "Алекс", 10), new Person(1, "9575789", "Алекс", 12), new Person(2, "575756", "Василий", 8), new Person(3, "475675647", "Михаил", 9), new Person(4, "56457567657", "Анжелика", 11), new Person(5, "45757567", "Александра", 15)));
    ...
    static List<String> findPhonesByName(List<Person> list, String name) {
        return list.stream().filter(p -> p.getName().equalsIgnoreCase(name)).map(p -> p.getPhone()).collect(Collectors.toList());
    }
